...
async function seedParametrosPadre() {
    const parametrosPadre = [
        ...
        { clave: "padre.hijos.maximo_mensaje", valor: "Tienes {{activos}} de {{maximo}} menores activos. Si quieres registrar otro, primero inactiva uno.", tipo: TipoParametro.STRING, descripcion: "Mensaje que ve el padre al alcanzar el tope de menores ACTIVOS (SPEC-361 · A-70 F5). Admite {{activos}} y {{maximo}}" },
