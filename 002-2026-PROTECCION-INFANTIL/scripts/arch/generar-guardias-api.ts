...
interface RutaAPI {
    ...
    // Detalle cuando failClosed === "exenta_selectiva". `| undefined` explícito
    // porque `exactOptionalPropertyTypes: true` no acepta `undefined` bajo la
    // sintaxis `?:` sola.
    detalleSelectiva?: DetalleExentaSelectiva | undefined;
