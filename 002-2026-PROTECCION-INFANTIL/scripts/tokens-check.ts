...
// 2026-09-05 SPEC-470: el mueble `Select.tsx` (56 pantallas) — el único crudo era
// el par del error `text-red-600 dark:text-red-400` → token `rubi`. Salen 2 crudos.
// Medición sobre origin/main fresco (con Button, 1021): 1019 (119 archivos).
const PISO = 1019;
