...
## Por qué va apilada sobre #330

`lib/profesional/cita/comision.ts` nació en SPEC-425, que además ya cambió `api/padre/citas` para importarlo. Ramar desde `main` obligaría a crear el módulo otra vez y a tocar la misma ruta: conflicto asegurado en los dos archivos. Apilada, el diff es el cambio real y nada más.
