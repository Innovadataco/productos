...
| `circulo-confianza/notificaciones.ts` | **Cero llamadores.** El barrel la reexporta; 5 archivos importan el barrel y ninguno importa ese símbolo. Código muerto. |
...
- **Cablear, no reescribir**, el aviso del círculo: en el punto que su propia spec nombra.
...
|---|---|
| Que el cable se vuelva a caer | Candado que exige el llamador REAL en el archivo que dispara, no la existencia de la función. Muere al borrar la línea. |
