...
- **US4 (P2 · ola-2 · BLOQUEADA) — Enterarse con reporte:** cuando reportan una cuenta de un hijo, el gráfico enciende ese hijo en **ámbar** y su **detalle** trae clasificación · cuándo · dónde + conteo honesto (verificados vs anónimos, nunca sumados) + guía + psicólogo. **Bloqueada:** necesita el cruce de reportes **por hijo** (carril Datos, D-121) y va **después de SPEC-644** (franja). **No se inventa: placeholder señalado.**
