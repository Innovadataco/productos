...
| [372](372-asignar-huerfanos-edad-servidor/spec.md) | SPEC-372 · A-74 P3+P4 — botón "Asignar huérfanos ahora" (endpoint admin + UI, mismo patrón de reasignar y misma auditoría que el cron) y edad 5-17 en el schema del servidor de POST /api/padre/hijos (I-262), con la misma constante que la UI | 🟡 En desarrollo |
