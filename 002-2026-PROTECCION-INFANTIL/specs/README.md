...
| [372](372-asignar-huerfanos-edad-servidor/spec.md) | SPEC-372 · A-74 P3+P4 — botón "Asignar huérfanos ahora" (endpoint admin con las guardas del patrón reasignar + audit del disparo) y edad 5-17 en el schema del servidor de POST y PATCH /api/padre/hijos (I-262), con helper compartido con la UI | 🟡 En desarrollo |
