...
| [320](320-identificadores-integridad-identidad/spec.md) | SPEC-320 · Identificadores: integridad + identidad (A-58 SPEC-A) · unicidad por colegio cross-sujeto (warn+override) + documento profesor obligatorio + catálogo único tipos documento (002-PI-220 · I-213) | 🟡 En desarrollo |
