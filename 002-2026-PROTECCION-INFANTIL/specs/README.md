...
| [386](386-decisiones-colegio-medias-cursos-excel/spec.md) | SPEC-386 · Excel de CURSOS (D5a · continúa SPEC-379) — plantilla + validador + endpoints + panel `CargaCursosExcel` en `/dashboard/colegio/cursos`, con test-candado de autoconsistencia (I-245 aplicado a cursos) | 🟡 En desarrollo |
