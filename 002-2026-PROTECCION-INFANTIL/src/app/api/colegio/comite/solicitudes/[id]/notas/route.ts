...
import { cuidIdSchema, notaSeguimientoSchema } from "@/lib/schemas";
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const resultado = await new ComiteConvivenciaBandejaService().agregarNota(
        ...
        return errorToResponse(error, "[COLEGIO/COMITE/SOLICITUDES/[ID]/NOTAS]");
    }
}
