/**
 * SPEC-179 (I-59) — Sub-nav del área Estadísticas del admin: 3 destinos
 * (Operación · Clasificación ?tab= · Motor), activo por pathname+searchParams.
 */
...
describe("EstadisticasSubNav (SPEC-179, I-59)", () => {
    ...
    it("muestra los 3 destinos con sus hrefs exactos", () => {
