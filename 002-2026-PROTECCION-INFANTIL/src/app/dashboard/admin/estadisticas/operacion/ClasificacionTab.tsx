...
/**
 * SPEC-171 (Pilar B) — Contenido del tablero de Clasificación, movido tal cual
 * desde la antigua ruta /dashboard/admin/estadisticas/clasificacion para vivir
 * como sub-tab dentro del tablero operativo. No se pierde ninguna métrica.
 */
...
export function ClasificacionTab() {
    ...
    return (
        <section className="space-y-6" aria-labelledby="clasificacion-title">
            <div className="mb-2">
                <h2 id="clasificacion-title" className="text-xl font-bold text-body">Clasificación</h2>
            ...
            <GlassCard className="p-4">
                <h3 className="mb-4 text-lg font-semibold text-body">Métricas por operador</h3>
            ...
            <GlassCard className="p-4">
                <h3 className="mb-4 text-lg font-semibold text-body">Casos operativos</h3>
