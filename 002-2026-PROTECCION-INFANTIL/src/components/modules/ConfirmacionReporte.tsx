    ...
    return (
        <div className="mx-auto max-w-md text-center animate-floatUp">
            <GlassCard className="space-y-5">
                ...
                <h2 className="text-xl font-bold text-body">Hemos recibido tu reporte</h2>
                <p className="text-sm text-muted">
                    Guarda este número para consultar el estado en cualquier momento:
                </p>

                <div className="flex items-center justify-center gap-3">
                    <code className="rounded-lg bg-tinta/5 px-4 py-2 text-lg font-mono font-bold text-body tracking-wide">
                        {numeroSeguimiento}
                    </code>
