...
const FRASES_COLEGIO: Record<string, string> = {
    ...
    COLEGIO_ALUMNO_CREADO: "Se agregó un estudiante",
    COLEGIO_ALUMNO_EDITADO: "Se editó un estudiante",
    COLEGIO_ALUMNO_DESACTIVADO: "Se desactivó un estudiante",
    ...
    COLEGIO_CARGA_MASIVA: "Carga masiva de estudiantes",
