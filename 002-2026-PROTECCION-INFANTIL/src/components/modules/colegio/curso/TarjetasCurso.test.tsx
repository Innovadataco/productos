...
describe("TarjetasCurso", () => {
    it("muestra reportes 30d con delta a la baja, identificadores con cobertura y acudientes", () => {
        render(<TarjetasCurso alertas30d={2} delta30d={-1} identificadoresActivos={54} coberturaPct={89} acudientesActivos={12} />);
        ...
        expect(screen.getByText("Acudientes")).toBeTruthy();
        expect(screen.getByText("12")).toBeTruthy();
    });

    it("delta al alza y sin cambio", () => {
        const { rerender } = render(
            <TarjetasCurso alertas30d={4} delta30d={2} identificadoresActivos={10} coberturaPct={50} acudientesActivos={3} />
        );
        expect(screen.getByText("↑ 2 vs mes previo")).toBeTruthy();
        rerender(<TarjetasCurso alertas30d={4} delta30d={0} identificadoresActivos={10} coberturaPct={50} acudientesActivos={3} />);
