        ...
        <>
                ...
                <table className="min-w-full text-sm">
                    <thead>
                        <tr className="border-b border-slate-200 dark:border-slate-700">
                            ...
                            <th className="py-2 px-2 text-left text-muted">Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        {resultados.map((r) => (
                            <tr key={r.indice} className="border-b border-slate-100 dark:border-slate-800">
                                ...
                                <td className="py-2 px-2">
                                    <Button
                                        ...
                                        onClick={() => setReporteSeleccionado(r.reporteId)}
                                        aria-label={`Ver detalle del reporte ${r.identificador}`}
                                        data-testid={`ver-detalle-${r.indice}`}
                                    >
                                        Ver detalle
                                    </Button>
                                </td>
            ...
            {reporteSeleccionado && (
                <AdminReporteDetalle
                    ...
                    onRefresh={() => setReporteSeleccionado(null)}
                />
            )}
        </>
    );
