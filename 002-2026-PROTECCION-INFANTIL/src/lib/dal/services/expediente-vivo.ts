...
/**
 * SPEC-340 (§3.3-bis) · S-C (D-116/D-117): el texto de TRABAJO del reporte PROPIO, descifrado.
 * La AUTORIDAD (step-up / sesión joven) la valida la ruta ANTES de llamar; acá el gate de
 * TITULARIDAD vive en el `where` (usuarioId + no eliminado) y el descifrado sale por el único
 * camino central (`descifrarCampo`, fail-loud). Devuelve null si el reporte no es del padre.
 */
