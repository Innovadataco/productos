...
export async function obtenerReporte(reporteId: string): Promise<{ ok: true; reporte: Reporte & { texto: string } } | { ok: false; response: NextResponse }> {
    ...
    return { ok: true, reporte: { ...reporte, texto } };
}
