...
export const UNIT_TEST_INCLUDES: string[] = [
    ...
    "src/components/modules/service-worker.candado.test.tsx",
    // SPEC-527: voseo por CLASE (imperativos -á/-é/-í + presentes -ás/-és/-ís) en dashboard+módulos.
    ...
    // SPEC-740: el registro del profesional es un asistente de 3 pasos, espejo del /camino (render + datos).
    "src/components/modules/profesional/wizard-profesional.candado.test.tsx",
    // SPEC-705: la pantalla de autorización respeta releer (solo lectura vs redirige; mocks, sin BD).
    "src/app/perfil-profesional/autorizacion/releer-solo-lectura.candado.test.tsx",
    ...
    // SPEC-652: el paso 4 del alta, en pausa, muestra solo la prueba gratis y
    // ningún precio pago placeholder (fs + render, sin BD).
    "src/app/camino/alta-planes-en-pausa.candado.test.tsx",
    ...
    // SPEC-513 (PA-21): la cota de futuro de fechaIncidente vive en UN validador;
    // ninguna ruta de app/api/** declara el suyo (el evento derivaba con Date.parse).
    "src/lib/fecha-incidente-schema-unico.candado.test.ts",
    ...
    "src/components/modules/padre/presentacion-en-mi-perfil.candado.test.tsx",
    ...
    // SPEC-609: el área del padre no ofrece crear contraseña (antirregresión de clase, revierte 598).
    "src/app/dashboard/padre/una-cuenta-una-puerta.candado.test.ts",
