// DTOs del payload de despacho (POST /api/integracion/despachos), del modelo real del frontend
// (frontend-gestion-despachos/src/app/despachos/models/Integracion.ts).
...
// Maestras (read-through)
export interface RutaMaestra extends ObjRutasIntegracion {
  nombre?: string;
}
export type AutorizacionMaestra = Record<string, unknown>;
