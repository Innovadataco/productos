      ...
      <section className="px-4 py-6">
        <div className="animate-fade-up">
          <div className="mb-4 flex items-center justify-between">
            <h1 className="text-headline text-ink">Simulacro mixto</h1>
        ...
        {pregunta ? (
          ...
          <div className="card mt-6 border border-dashed border-ink-subtle/30 p-6 text-center">
            <p className="text-body text-ink-muted">No hay preguntas cargadas para el simulacro aún.</p>
            <Link href="/home" className="btn-secondary mt-4 w-full">
              Volver al inicio
            </Link>
          </div>
        )}
